...
Source0  : https://github.com/ccache/ccache/releases/download/v4.9.1/ccache-4.9.1.tar.xz
Source1  : https://github.com/ccache/ccache/releases/download/v4.9.1/ccache-4.9.1.tar.xz.asc
Source2  : ccache.sh
...
%prep
%setup -q -n ccache-4.9.1
cd %{_builddir}/ccache-4.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707230672
mkdir -p clr-build
pushd clr-build
