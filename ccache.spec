...
Source0  : https://github.com/ccache/ccache/releases/download/v4.9/ccache-4.9.tar.xz
Source1  : https://github.com/ccache/ccache/releases/download/v4.9/ccache-4.9.tar.xz.asc
Source2  : ccache.sh
...
%prep
%setup -q -n ccache-4.9
cd %{_builddir}/ccache-4.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704136010
mkdir -p clr-build
pushd clr-build
